...
(function (io) {
	...
	socket.on('connect', function socketConnected() {
		...
		socket.on('message', cometMessageRecievedFromServer);
...
function updateUserInDom(userId, message){
	...
	switch(page) {
		...
		// If we're on the User Admin page (aka user index)
		case '/user':

			// This is a message coming from publish Update
